...
<body style="background-image: url('../img/Captura.PNG');">
    <section>
        <form method="post" action="../controlador/logica.php">
            <h1 style="color: white;">Verificación de correo electronico</h1>
            <div class="inputbox">
                <input type="text" name="correo_electronico" id="email" required>
                <label for="">Ingresa tu correo electronico</label>
                <span class="icon"><i class="fa-solid fa-envelope"></i></span>
            </div>
            <input class="btn" type="submit" value="Verificar" name="validate_email">
            <br><br>

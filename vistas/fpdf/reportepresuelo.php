...
class PDF extends FPDF
{
   ...
   function Header()
   {
      if ($this->isFirstPage) {
         ...
         $this->Cell(80, 20, utf8_decode("REPORTE DE LAS PREDICCIONES DEL SENSOR SUELO"), 0, 1, 'C', 0);
         $this->Ln(10);
...
$sql = "SELECT * FROM datos_suelo_predicciones";
...
while ($row = $result->fetch_assoc()) {
   ...
   $pdf->Cell(43, 10, utf8_decode($row['created_at']), 1, 1, 'C', 0);
}

// Agregar pie de página
$pdf->Footer();
$pdf->Output('Reporte_Predicciones_Suelo.pdf', 'I');

...
class PDF extends FPDF
{
   ...
   function Header()
   {
      if ($this->isFirstPage) {
         ...
         $this->Cell(80, 20, utf8_decode("REPORTE DE PREDICCIONES DEL SENSOR METEOROLOGICO"), 0, 1, 'C', 0);
         $this->Ln(10);
...
$sql = "SELECT * FROM datos_meteorologicos_predicciones;";
...
while ($row = $result->fetch_assoc()) {
   ...
   $pdf->Cell(50, 10, utf8_decode($row['date']), 1, 1, 'C', 0);
}

$pdf->Output('Reporte_Predicciones_Clima.pdf', 'I');
$conexion->close();

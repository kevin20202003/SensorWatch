...
class PDF extends FPDF
{
   ...
   function Header()
   {
      if ($this->isFirstPage) {
         ...
         $this->Cell(100, 20, utf8_decode("REPORTE DE PREDICCIONES DEL SENSOR AMBIENTE"), 0, 1, 'C', 0); // Aumenta el alto de la celda
...
$sql = "SELECT * FROM datos_ambiente_predicciones;";
...
// Pie de página
$pdf->Footer();
$pdf->Output('Reporte_Predicciones_Ambiente.pdf', 'I');

...
<head>
    ...
    <script>
        ...
        function fetchData() {
            ...
            fetch('../get_environment_data.php')
                .then(response => response.json())
                .then(data => {
                    if (data) {
                        // Actualizar los elementos con los datos recibidos
                        document.querySelector('.temperatura_ambiental').innerText = data.temperatura_amb + " °C";
                        document.querySelector('.humedad_ambiental').innerText = data.humedad_amb + " %";
                        document.querySelector('.lux').innerText = data.lux + " lux";
                    }
                })
...
<body id="body-pd" style="background-image: url(../img/fondo7.jpg); background-repeat: no-repeat;
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="ambiente.php" class="nav_link active" data-toggle="tooltip" data-placement="right" title="Interfaz de Ambiente">
        ...
        <div class="height-100">
            <div class="container mt-4">
                ...
                <div class="button-container">
                    ...
                    <a href="fpdf/reporteambiente.php" class="btn btn-danger btn-lg me-2" target="_blank">Generar Reporte <i class="fa-solid fa-file-pdf"></i></a>
                    <a href="../vendor/reporteexcel2.php" class="btn btn-success btn-lg me-2" target="_blank">Generar Reporte <i class="fa-solid fa-file-excel"></i></a>
                </div>
                <br><br>
                <div class="row" style="align-items: center; text-align: center; justify-content: center;">
                    <div class="col-md-3">
                        <div class="green-box" data-bs-toggle="modal" data-bs-target="#chartModalLuz" data-variable="Luz">
                            ...
                            <span class="number lux">Cargando... lx</span>
                        </div>
                        <br>
                        <span style="font-weight: bold; font-size: large;">Luz</span>
                    </div>
                    <div class="col-md-3">
                        <div class="green-box" data-bs-toggle="modal" data-bs-target="#chartModalHumedad" data-variable="Humedad">
                            ...
                            <span class="number humedad_ambiental">Cargando... %</span>
                        </div>
                        <br>
                    ...
                    <div class="col-md-3">
                        <div class="green-box" data-bs-toggle="modal" data-bs-target="#chartModalTemperatura" data-variable="Temperatura">
                            ...
                            <span class="number temperatura_ambiental">Cargando... °C</span>
                        </div>
                        <br>
                        <span style="font-weight: bold; font-size: large;">Temperatura interna</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="chartModalLuzLabel">Gráfico de Luz</h5>
    ...
    <script>
        document.getElementById('saveAlarm').addEventListener('click', function() {
            ...
            // Validar campos
            if (humedad_min === '' || humedad_max === '' || temperatura_min === '' || temperatura_max === '') {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
            ...
            fetch('../controlador/save_alarm_ambiente.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    <?php
    include '../controlador/enviar_alerta_ambiente.php';
    ?>
</body>

document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if (contenedorBotones) {
        ...
        contenedorBotones.addEventListener('click', (e) => {
            ...
            if (tipo === 'exito') {
                agregarToast({ tipo: 'exito', titulo: 'Exito!', descripcion: 'La operación fue exitosa.', autoCierre: true }, contenedorToast);
            }
            if (tipo === 'error') {
                agregarToast({ tipo: 'error', titulo: 'Error', descripcion: 'Hubo un error', autoCierre: true }, contenedorToast);
            }
            if (tipo === 'info') {
                agregarToast({ tipo: 'info', titulo: 'Info', descripcion: 'Esta es una notificación de información.' }, contenedorToast);
            }
            if (tipo === 'warning') {
                agregarToast({ tipo: 'warning', titulo: 'Warning', descripcion: 'Ten cuidado' }, contenedorToast);
            }
        });
    }
...
const agregarToast = ({ tipo, titulo, descripcion, autoCierre }, contenedorToast) => {

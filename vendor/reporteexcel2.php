...
$sheet->setTitle('Reporte de Sensor Ambiente');

// Configuración del título del reporte
$sheet->mergeCells('A1:E1');
$sheet->setCellValue('A1', 'Reporte del Sensor Ambiente');
...
$headers = ['Humedad', 'Temperatura', 'Luz', 'Fecha'];
...
while ($row = $result->fetch_assoc()) {
    ...
    $ph = number_format($row['lux'], 2) . " lux";
...
header('Content-Disposition: attachment;filename="Reporte_Ambiente.xlsx"');
